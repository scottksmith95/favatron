...
function stopShepherd() {
  ...
  xmlhttp.open("GET", "/account/tour", true);
  xmlhttp.send();
}
...
shepherd.addStep('welcome', {
  title: 'Welcome to Favatron',
  text: ['Favatron works by analyzing favorited tweets for web page links. We then summarize the page\'s content and provide that data to you in many forms.', 'We are in the process of pulling down and processing the last 200 tweets you favorited from Twitter.', 'This should take at most one minute.  We will then do this automatically for all future favorites.'],
...
shepherd.addStep('api', {
  title: 'Developer API',
  text: ['Access all your favorites with our developer API to create your own services and integrations.'],
  attachTo: '#nav-api bottom',
  classes: 'shepherd shepherd-open shepherd-theme-arrows shepherd-transparent-text',
  buttons: [
    {
      text: 'Back',
...
shepherd.addStep('feed', {
  title: 'RSS Feed',
  text: ['Do you prefer using RSS readers to read articles? Simply plug this link into your RSS reader to start consuming your custom RSS feed.'],
  attachTo: '#nav-feed bottom',
  classes: 'shepherd shepherd-open shepherd-theme-arrows shepherd-transparent-text',
  buttons: [
    {
      text: 'Back',
...
shepherd.addStep('integrations', {
  title: 'Integrations',
  text: ['You can optionally link to read it later type services such as <a href="https://readability.com/" target="_blank">Readability</a> and <a href="https://getpocket.com/" target="_blank">Pocket</a>. Processed links will be pushed to these services automatically.'],
  attachTo: '#nav-account bottom',
  classes: 'shepherd shepherd-open shepherd-theme-arrows shepherd-transparent-text',
  buttons: [
    {
      text: 'Back',
...
shepherd.addStep('options', {
  ...
  text: ['In this section you can control many of the available features provided by us: <ul><li>Daily email digest</li><li>Weekly email digest</li><li>RSS feed</li><li>Developer API</li><li>Webhooks</li><li>Include favorites without links</li></ul>'],
  attachTo: '#nav-account bottom',
  classes: 'shepherd shepherd-open shepherd-theme-arrows shepherd-transparent-text',
  buttons: [
    {
...
shepherd.addStep('profile', {
  ...
  text: ['Personalize your account here by setting your account vanity url, email address, and display name.'],
  attachTo: '#nav-account bottom',
  classes: 'shepherd shepherd-open shepherd-theme-arrows shepherd-transparent-text',
  buttons: [
    {
...
shepherd.addStep('contact', {
  title: 'Help and Assistance',
  text: ['Feel free to email us anytime with questions, suggestions, or just to say hi. You can also reach us on Twitter, Facebook, and Google+.'],
  attachTo: '#contact top',
  classes: 'shepherd shepherd-open shepherd-theme-arrows shepherd-transparent-text',
  buttons: [
    {
      text: 'Back',
...
// h4.highlight(style="margin-bottom: 5px;") Favatron
// a.twitter-follow-button(href="https://twitter.com/favatron", data-show-count="false", data-size="large", data-show-screen-name="false", data-dnt="true") Follow
// h4.highlight(style="margin-bottom: 5px;") Scott Smith
// a.twitter-follow-button(href="https://twitter.com/scottksmith95", data-show-count="false", data-size="large", data-show-screen-name="false", data-dnt="true") Follow